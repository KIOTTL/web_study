...
<title>style</title>
<link rel="stylesheet" href="../home/style/Copy-of-style3.css" media="screen">
          ...
          <div class="u-tab-content">
              ...
              <div class="u-container-layout u-container-layout-1">
                ...
                <div class="u-list u-list-2">
                  ...
                  <c:forEach var="vo" items="${list }">
                    <div class="u-container-style u-list-item u-radius-3 u-repeater-item u-shape-round u-white u-list-item-6">
                    <!-- <div class="u-border-2 u-border-white u-container-style u-grey-5 u-list-item u-radius-20 u-repeater-item  u-shape-round u-list-item-6" style="border: solid 1px #d9d9d9; background-color:white; height:471px;"> -->
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        <span class="u-file-icon u-icon u-text-palette-5-base u-white u-icon-1">
                          <img src="../images/style/64572.png" alt=""></span>
                        <h6 class="u-custom-font u-font-source-sans-pro u-text u-text-default u-text-6">shoe_style</h6>
                        <input type="hidden" name=id value="${vo.id }">
                        <a href="../style/style_detail_before.do?id=${vo.id }"><img class="u-border-1 u-border-grey-10 u-expanded-width u-image u-image-contain u-image-default u-image-1" src="${vo.img }" alt="" data-image-width="400" data-image-height="265"></a>
                        <div style="clear: both;"></div>
                        <p class="u-align-left u-small-text u-text u-text-variant u-text-7"><a href="#">${vo.content }</a><br></p>
                        ...
                        <p class="u-small-text u-text u-text-default u-text-variant u-text-8" style="font-size: 0.75rem; margin: 14px auto 0 40px;">12&nbsp;</p>
                        <p class="u-small-text u-text u-text-default u-text-variant u-text-9" style="font-size: 0.75rem; margin: -19px auto 0 85px;">12&nbsp;</p>
                        <span class="u-file-icon u-icon u-icon-2"><img src="../images/style/heart.png" alt="" style="width: 19px; height: 18px;" ></span>
                        <span class="u-file-icon u-icon u-icon-3"><img src="../images/style/chat.png" alt="" style="width: 21px; height: 20px;"></span>
            ...
            <div class="u-align-left u-container-style u-tab-pane" id="tab-2917" role="tabpanel" aria-labelledby="link-tab-2917">
              ...
              <div class="u-list u-list-3">
                ...
                <c:forEach var="vo" items="${list }">
                  <div class="u-container-style u-list-item u-radius-3 u-repeater-item u-shape-round u-white u-list-item-10">
                    <div class="u-container-layout u-similar-container u-container-layout-12"><span class="u-file-icon u-icon u-text-palette-5-base u-white u-icon-13"><img src="../images/style/64572.png" alt=""></span>
                      <h6 class="u-custom-font u-font-source-sans-pro u-text u-text-default u-text-22">shoe_style</h6>
                        <img class="u-border-1 u-border-grey-10 u-expanded-width u-image u-image-contain u-image-default u-image-5" src="${vo.img }" alt="" data-image-width="400" data-image-height="265">
                        <p class="u-align-left u-small-text u-text u-text-variant u-text-23"><a href="#">${vo.content }</a><br></p>
                        <p class="u-small-text u-text u-text-default u-text-variant u-text-24" style="font-size: 0.75rem; margin: 14px auto 0 40px;">12&nbsp;</p>
                        <p class="u-small-text u-text u-text-default u-text-variant u-text-25" style="font-size: 0.75rem; margin: -19px auto 0 85px;">12&nbsp;</p>
                        <span class="u-file-icon u-icon u-icon-14"><img src="../images/style/heart.png" alt="" style="width: 19px; height: 18px;" ></span>
                        <span class="u-file-icon u-icon u-icon-15"><img src="../images/style/chat.png" alt="" style="width: 21px; height: 20px;"></span>
                    </div>
                  </div>
                </c:forEach>
                </div>
