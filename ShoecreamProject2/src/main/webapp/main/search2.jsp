...
<section class="u-clearfix u-section-1" id="sec-6bda">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-repeater u-repeater-1" style="height: 1530px; margin-left: -200px; width: 1523px; margin-top: 10px;">
      ...
      <nav aria-label="Page navigation example">
		  <ul class="pagination" style="margin-bottom: 199px;">
		    <li class="page-item">
		      ...
		      <a class="page-link" href="search.do?page=${startPage-1 }" aria-label="Previous">
		    ...
		    <c:forEach var="i" begin="${startPage }" end="${endPage }">            
	            ...
	            <li ${style } ><a href="search.do?page=${i }" >${i }</a></li>
	       </c:forEach>

		    <li class="page-item">
		    
		      <c:if test="${endPage < totalpage }">
		      <a class="page-link" href="search.do?page=${endPage+1 }" aria-label="Next">
