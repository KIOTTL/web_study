        ...
        <c:if test="${s.index>=0 && s.index<8 }">
          <div class="u-align-left u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              ...
              <a href="../main/search.do?fd=${vo.brand }" style="color:black"><p class="u-text u-text-default u-text-3">${vo.brand }<br></p></a>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-expanded-width u-list u-list-1">
          ...
          <c:if test="${s.index>=0 && s.index<5 }">
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <a href="../style/style_detail_before.do?id=${vo.id }"><img alt="" class="u-expanded-width u-image u-image-default u-image-1" data-image-width="2000" data-image-height="1333" src="${vo.img }" style="height:100%; object-fit: cover; border-radius: 10px;"></a>
