      ...
      <c:forEach var="vo" items="${list }" varStatus="s">
       	<c:if test="${s.index>=0 && s.index<12 }">
            ...
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <a href="../shoes/shoes_list.do?goods_id=${vo.getGoods_id() }"><img class="u-expanded-width u-image u-image-default u-image-1" src="${vo.img }" alt="" style="height: 320px;" data-image-width="400" data-image-height="400"></a>
