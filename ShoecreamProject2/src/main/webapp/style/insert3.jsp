          ...
          <div class="u-container-layout u-container-layout-1" >
            ...
            <div class="u-border-1 u-border-grey-75 u-container-style u-group u-white u-group-2" style="margin-top:50px;">
              <div class="u-container-layout u-container-layout-2" style="border: 1px solid; ">
                <img class="u-image u-image-default u-image-1" src="../images/style/5.svg" alt="" data-image-width="400" data-image-height="265" style=" width: 460px; height: 339px; margin: 22px auto 0 32px;">
                <div class="u-form u-form-1">
                  <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-15 u-inner-form" source="email">
                    <div class="u-form-email u-form-group u-label-top">
                      <label for="email-558c" class="u-form-control-hidden u-label"></label>
                      <input type="email" placeholder="파일 선택" id="email-558c" name="file" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" style="border:1px solid grey" required="">
                    </div>
                    <div class="u-form-group u-form-submit">
                      <a href="#" class="u-black u-btn u-btn-submit u-button-style u-btn-1"><span class="u-file-icon u-icon"><img src="../images/style/6.png" alt=""></span>
                      </a>
