...
<link rel="stylesheet" href="../home/style/detail/nicepage.css" media="screen">
...
<body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-3134">
      <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-text-palette-5-base u-white u-icon-1"><img src="../home/style/images/64572.png" alt=""></span>
        ...
        <h6 class="u-custom-font u-font-open-sans u-text u-text-default u-text-grey-25 u-text-2">25분 전</h6>
      </div>
    </section>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h6 class="u-text u-text-default u-text-1">댓글 2개</h6>
              ...
              <table class="u-table-entity">
                ...
                <tbody class="u-table-body">
                  <tr style="height: 25px;">
                    <td class="u-table-cell u-table-valign-middle u-table-cell-1"><span class="u-file-icon u-icon u-text-palette-5-base u-white u-icon-1"><img src="../home/style/images/64572.png" alt=""></span>&nbsp; 
                    </td>
                  </tr>
            ...
            <div class="u-form u-form-1">
              <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="email" name="form">
                <div class="u-form-group u-form-message u-label-top u-form-group-1">
                  ...
                  <textarea placeholder="댓글 작성.." rows="2" cols="50" id="message-6797" name="message" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-18" required="" style="border: 1px solid; border-color: #b3b3b3;"></textarea>
                </div>
