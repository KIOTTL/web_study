      ...
      <div class="u-clearfix u-sheet u-sheet-1" style="min-height: 905px;">
        <div class="u-container-style u-group u-shape-rectangle u-white u-group-1" style="width: 881px;min-height: 822px;background-image: none;height: auto;margin: 79px auto 4px;">
          <div class="u-container-layout u-container-layout-1" style="padding: 0 0 5px; margin: 0 5 10 5px;">
            ...
            <div class="u-border-1 u-border-grey-75 u-border-no-bottom u-container-style u-group u-white u-group-2" style="width: 479px; min-height: 340px; background-image: none; height: auto;margin: 22px auto 0; ">
              <div class="u-container-layout u-valign-middle u-container-layout-2" style="padding: 0; margin-top:0px; border-top: solid 1px black; border-right: solid 1px black; border-left: solid 1px black;">
                <img class="u-image u-image-contain u-image-default u-image-1" style="width: 400px;height: 305px;margin: 0 auto;" src="" onerror="this.src='5.svg'"alt=""  id="uploadImage" data-image-width="400" data-image-height="265">
              </div>
            </div>
            <form method=post action="../style/input_ok.jsp" class="frm" enctype="multipart/form-data" target="blankifr" id="frm2">
            <div class="u-border-1 u-border-grey-75 u-border-no-top u-container-style u-group u-group-3" style="width: 479px; min-height: 82px; height: auto; margin: 0 auto; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">
                ...
                <div class="u-container-layout u-container-layout-3" style="padding-left: 30px; padding-right: 30px;">
                  <div class="u-form u-form-1" style="height: 64px; margin: 13px 0 0 0;">
                      <!-- <div class="u-form-group u-form-name u-label-top"  >
                        ...
                        <input type="text" placeholder="파일" id="name-558c" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-input-1" style="height: 32px;font-size: 0.875rem; border:1px solid #c0c0c0; width:154px;" required="">
                      </div> -->
			...
			<form method=post action="../style/insert_ok.do" class="frm" id="frm1">
            <div class="u-form u-form-2" style="height: 214px;width: 655px;margin: 39px auto 0;">
             <!--  <form action="../style/insert_ok.do" method="POST" id="frm2"  class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 0;" source="email" name="form"> -->
                <div class="u-form-group u-form-message u-form-group-3" style="margin-top: 0; margin-bottom: 10px;">
                  ...
                  <textarea placeholder="문구 입력..." rows="4" cols="50" id="content" name="content" class="u-border-1 u-border-grey-75 u-input u-input-rectangle" style="border:1px solid #404040" required=""></textarea>
                </div>
