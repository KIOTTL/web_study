...
<section class="u-clearfix u-section-1" id="sec-6bda">
  ...
  <p class="u-text u-text-default u-text-1">MEN</p>
  <p class="u-text u-text-default u-text-2">Home &gt; MEN &gt; 스니커즈</p>
      ...
      <c:forEach var="vo" items="${list }" varStatus="s">
       	<c:if test="${s.index>=0 && s.index<8 }">
            ...
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <a href="../shoes/men_list.do?goods_id=${vo.goods_id }"><img class="u-image u-image-default u-image-1" src="${vo.img }" alt="" data-image-width="400" data-image-height="265"></a>
