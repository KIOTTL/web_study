...
$(function(){	// window.onload (Java=main())
	...
	$('#delBtn').on("click",function(){		/* .click(function())과 동일 */    
		let pwd=$('#pwd').val();
		if(pwd.trim()=="") {
			$('#pwd').focus();
			return;
  ...
  <div class="container">
    ...
    <div class="row">
      <table class="table">
        ...
        <tr>
          <td colspan="4" valign="top" class="text-left" height="200"><pre style="white-space: pre-wrap; background-color: white; border: none">${vo.content }<!-- pre-wrap : 자동 줄바꿈 --></pre></td>
        </tr>
        <tr>
        ...
        <tr id="delTr" style="display: none">
          <td colspan="4" class="text-right">
            <%-- HTML (태그는 사용자 정의 불가, 속성은 사용자 정의 가능) --%>
