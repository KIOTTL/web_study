...
public class GoodsModel {
	...
	public String goods_all(HttpServletRequest request, HttpServletResponse reseponse) {
	...
	public String goods_best(HttpServletRequest request, HttpServletResponse reseponse) {
		String page=request.getParameter("page");
		if(page==null)
			page="1";
		int curpage=Integer.parseInt(page);
	...
	public String goods_special(HttpServletRequest request, HttpServletResponse reseponse) {
		String page=request.getParameter("page");
		if(page==null)
			page="1";
		int curpage=Integer.parseInt(page);
	...
	public String goods_new(HttpServletRequest request, HttpServletResponse reseponse) {
		String page=request.getParameter("page");
		if(page==null)
			page="1";
		int curpage=Integer.parseInt(page);
	...
	public String goods_detail(HttpServletRequest request, HttpServletResponse reseponse) {
