...
<div class="wrapper row3">
  <main class="container clear"> 
    <!-- main body --> 
    <h3 class="sectiontitle">묻고 답하기</h3>
    <div class="two_third first" style="height: 450px">
      <table class="table">
        <tr>
          <td>
            <a href="../board_reply/insert.do" class="btn btn-xs btn-danger">새 글</a>
          </td>
        </tr>
      </table>
      <table class="table">
        <tr>
          <%--
          		adadad (3) ==> reply ==> insert freeboard->rcount++
           --%>
