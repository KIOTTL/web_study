        ...
        <c:if test="${s.index>=0 && s.index<8 }">
          <div class="u-align-left u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-container-layout-1">
              <a href="../shoes/shoes_detail_before.do?id=${vo.id }"><img class="u-expanded-width u-image u-image-default u-image-1" src="${vo.img }" alt="" data-image-width="400" data-image-height="265" ></a>
              ...
              <p class="u-text u-text-default u-text-4"><a href="../shoes/shoes_detail_before.do?id=${vo.id }" style="color:black">${vo.name_eng }</a></p>
              <a href="../shoes/shoes_detail_before.do?id=${vo.id }" style="color:black"><p class="u-text u-text-default u-text-5"><fmt:formatNumber pattern="#,###" value="${vo.im_buy }"/>원<br></p></a>
              <p class="u-text u-text-default u-text-6"><a href="../shoes/shoes_detail_before.do?id=${vo.id }" style="color:#A6A6A6">즉시구매가</a><br></p>
            </div>
          </div>
        </c:if>
        </c:forEach>
