      ...
      <div class="u-expanded-width u-list u-list-1">
        <div class="u-repeater u-repeater-1">
          <div class="u-align-left u-container-style u-list-item u-repeater-item">
             <f:forEach var="vo" items="${list }" varStatus="s">
              <div class="u-container-layout u-similar-container u-container-layout-1">
              <figure><img class="u-expanded-width u-image u-image-default u-image-1" src="${vo.img }" alt="" data-image-width="400" data-image-height="265">
	            <span class="u-icon u-text-palette-1-base u-icon-1">
	              ...
	              <p class="u-text u-text-default u-text-5">${vo.im_buy }<br></p>
