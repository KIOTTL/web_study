<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	19 page : 서버 ===> 웹서버, 톰캣 (WAS) : 자바 번역
			  클라이언트 ===> 웹 브라우저
			  
			  C/S
			    사용자 : 요청 => 주소란 이용해 요청
			                            ---- 요청 방식 : GET -> 요청 데이터를 보낼 때 URL 뒤에 첨부
			                            			   POST -> 내부 네트워크로 전송 (보안, 데이터가 많다)
			    서버 : 응답 (응답에 대한 처리 => 웹 프로그래머)
			    	  --- HTML, COOKIE, 이미지, JSON(Rest)
	22 page : Servlet : Java 형태 중간에 HTML을 이용해서 처리
					    => 효율성이 떨어진다
					    => 보안 (자바와 관련된 코딩은 Servlet을 이용)
					    => 스프링에서 라이브러리 제공
			  JSP ㅣ HTML 사용하기 편리
			  		CSS, JavaScript 사용 편리
			  		View(화면 출력용)
			  		=> 보안 취약 (jsp : 전체 소수 전송, java : class)
	24 page : JSP(Java Server Page) : 서버에서 실행하는 자바 파일
			  => 파일X, 페이지
			  동적 / 정적
