...
public class BoardDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BoardVO vo = dao.boardDetail(Integer.parseInt(no), 1);	// no => String
		...
		// <td width=30% align=center><%= vo.getName()%></td>  : jsp
		// <td width=30% align=center>${vo.name}</td>  : mvc
		// <td width=30% align=center th:text=${vo.name}></td>  : spring
		...
		out.println("</tr>");
		out.println("<tr>");
		out.println("<td colspan=4 align=left valign=top style=\"height:200px\">"+vo.getContent()+"</td>");	// table.css에서 td태그의 height 고정해놓음 => style로 변경
		out.println("</tr>");
