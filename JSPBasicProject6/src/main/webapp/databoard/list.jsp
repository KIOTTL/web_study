...
<body>
  <div class="container">
    ...
    <table class="table_content">
      <tr>
        <td>
          <a href="../main/main.jsp?mode=2">새 글</a>
        </td>
      </tr>
    </table>
    <table class="table_content">
    ...
    <table class="table_content">
      <tr>
        ...
        <td align=right>
          <a href="../main/main.jsp?mode=1&page=<%=curpage>1 ? curpage-1:curpage%>">이전</a>&nbsp;
		    <%=curpage %> page / <%=totalpage %> pages
          <a href="../main/main.jsp?mode=1&page=<%=curpage<totalpage ? curpage+1:curpage%>">다음</a>
        </td>
      </tr>
    </table>
  </div>
