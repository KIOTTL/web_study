	 	 ...
	 	 try {
	         ...
	         List<WebElement> el3 = driver3.findElements(By.className("search_result_item"));
           	 for (WebElement li:el) {
                  ...
                  System.out.print(li.findElement(By.tagName("img")).getAttribute("src"));
...
//                      System.out.print(element.findElement(By.tagName("img")).getAttribute("src"));
                    System.out.print("|"+li2.findElement(By.className("brand")).getText());         
                    System.out.print("|"+li2.findElement(By.className("name")).getText());
                    System.out.print("|"+li2.findElement(By.className("amount")).getText());
                    System.out.println();
...
//                   System.out.print(element.findElement(By.tagName("img")).getAttribute("src"));
                 System.out.print("|"+li3.findElement(By.className("brand")).getText());         
                 System.out.print("|"+li3.findElement(By.className("name")).getText());
                 System.out.print("|"+li3.findElement(By.className("amount")).getText());
                 System.out.println();
